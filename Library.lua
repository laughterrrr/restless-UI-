...
local library = {flags = {}, toggled = true, keybind = Enum.KeyCode.P, dragSpeed = 0}
...
local themes = {
    Dark = {
        ...
        ToggleEnabled = Color3.fromRGB(0,0,139),
        ToggleEnabledMouseOver = Color3.fromRGB(0,0,139),
        ...
        SliderFill = Color3.fromRGB(0,0,139),
        SliderFillSliding = Color3.fromRGB(0,0,139),

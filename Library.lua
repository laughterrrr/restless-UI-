...
local themes = {
    Dark = {
        ...
        ToggleDisabled = Color3.fromRGB(0, 0, 139),
        ToggleDisabledMouseOver = Color3.fromRGB(40, 40, 40),
        Box = Color3.fromRGB(0, 0, 139),
        BoxFocused = Color3.fromRGB(40, 40, 40),
        Slider = Color3.fromRGB(0, 0, 139),
        ...
        ColorPickerBoxes = Color3.fromRGB(0, 0, 139)
    },
    Light = {
